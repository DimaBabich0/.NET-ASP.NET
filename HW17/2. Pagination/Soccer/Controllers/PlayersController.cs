...
namespace Soccer.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public async Task<IActionResult> Index(int page = 1)
        {
            ...
            PlayersPageViewModel pageViewModel = new PlayersPageViewModel(count, page, pageSize);
            PlayersIndexViewModel viewModel = new PlayersIndexViewModel(items, pageViewModel);
